...
public class GMGame : MonoBehaviour
{
    ...
    public List<GDProp> Objects = new List<GDProp>();
    public List<GDPlayerCharacter> PlayerCharacters = new List<GDPlayerCharacter>();
    public List<GDControlledCharacter> AlliedCharacters = new List<GDControlledCharacter>();
    public List<GDAICharacter> WorldCharacters = new List<GDAICharacter>();
