...
public enum ELogicColors { eNone, eBlue, eRed, eGreen, eYellow, eOrange, ePurple, ePink, eBrown, eGrey, eWhite, eBlack };
public enum ELogicTypes { eNone, eKey, eKeyCard, eKeyCode, eRemoteControl, eSwitch, eButton, eTool, eToolB, eOtherA, eOtherB };
public enum EEntityClass { eDefault, eActionable, eBreakable, eConsumable, eDecorative, eDoor, eElectricSource, eGate, eStorage,
							eTool, eValuable, eWallHole, eWaterSource, eWeapon, eWindow }; // Security systems etc, hiddeable objs
public enum EEntityTypes {  eDefault, eAppliances, eComfort, eConsumable, eDecoration, eElectronic, eElectricity, eFood, eGate,
							eInstallation, eInstrument, eIndustrialEquipment, eTool, eToy, eMachine, ePlant,
                            ePlumbing, ePlayground, eStorage, eValueable, eVehicle, eWearable, eWeapon };
public enum EEntityRarity { ePoor, eCommon, eUncommon, eRare, eVeryRare, eLegendary, eUnique };

[CreateAssetMenu( fileName = "New Item", menuName = "Game/Data/Object/Item" )]
public class GDItem : ScriptableObject {
...
public static class GDItemUtils {
